...
?>
<form role="form" id="search_form" action="<?php echo $urlweb; ?>/proses_prepaid.php" method="POST">
  <div class="modal-body pt-5 pb-5 text-center">
    ...
    <table style="width: 100%;">
      <tbody>            
        ...
        <?php
          if($kabupaten_row['kategori'] == 'PLN' || $kabupaten_row['brand'] == 'PLN'){
            $params = array(
