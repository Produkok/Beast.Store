...
<head>
  ...
  <title>Not Found - <?php echo $s0['instansi']; ?></title>
  <meta name="description" content="<?php echo $s0['deskripsi']; ?>">
  <meta name="keywords" content="<?php echo $s0['keyword']; ?>">
  <meta property="og:title" content="Not Found - <?php echo $s0['instansi']; ?>"/>
    ...
    <div class="pt-5 pb-5">
      <div class="container">
       <div class="row">
          <div class="col-lg-12">
            <div class="pt-3 pb-3">
              <img src="<?php echo $urlweb; ?>/upload/404.png" class="img-fluid" style="display: block; margin: 0 auto; width: 50%;" alt="">
            </div>
          </div>
        </div>
      </div>
