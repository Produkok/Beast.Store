       ...
       <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <div class="card shadow-sm d-none d-sm-block">
              <div class="card-header text-white" style="border-bottom: 1px solid rgb(255,255,255,0.5);">Produk Pulsa Lainnya</div>
                ...
                <ul class="list-group" style="border-radius: 0;">
                  ...
                  <li class="list-group-item" style="background: var(--primary-color); color: var(--font-color); border-radius: 0;">
                    <div class="media">
                      ...
                      <h5 class="mt-3" style="font-size: 14px; line-height: 12px; color: #fff;"><a href="<?php echo $urlweb; ?>/pulsa/<?php echo $gk['slug']; ?>/" style="color: #fff;"><?php echo $gk['kategori']; ?></a></h5>
                      </div>
                    </div>
                  </li>
                  <?php } ?>
          ...
          <div class="col-sm-8">
            <div class="card shadow-sm mb-2" style="border-radius: 10px;">
              <div class="card-body mb-0" style="border-radius: 10px;">
                ...
                <div class="form-row pt-3">
                  <div class="col-6">
                      <input type="number" name="userID" id="userID" class="form-control" placeholder="08xxxxxx" >
                    </div>
                    <div class="col-6"> 
                      <select name="zone_id" id="zoneID" class="form-control">  
                        <option value="">Jenis Layanan</option>
                        <?php
                          $sql_31 = mysqli_query($conn,"SELECT * FROM `tb_prepaid` WHERE brand = '$brand' GROUP BY kategori ORDER BY kategori ASC") or die(mysqli_error());
                          while($s31 = mysqli_fetch_array($sql_31)){
                        ?>
                        <option value="<?php echo str_replace(' ','-',$s31['kategori']).'_'.$s31['brand']; ?>"><?php echo ucwords(strtolower(str_replace('-',' ',$s31['kategori']))); ?></option>
                        <?php } ?>
                      </select>
                    </div>
            ...
            <div class="card shadow-sm mb-2" style="border-radius: 10px;">
              <div class="card-body mb-0" style="border-radius: 10px;">
                ...
                <div class="row pt-3 pl-2 pr-2 mb-2" id="resultpulsa">
                  <?php
    ...
    <script>
      $(document).ready(function() {
        $("#zoneID").change(function (){
          url = "<?php echo $urlweb; ?>/select_prepaid.php?id="+$('#zoneID').val();
          $('#resultpulsa').load(url);
          //console.log(url);
          return false;
        });
