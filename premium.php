...
<head>
  ...
  <title>Top Up Premium - <?php echo $s0['instansi']; ?></title>
  <meta name="description" content="<?php echo $s0['deskripsi']; ?>">
  <meta name="keywords" content="<?php echo $s0['keyword']; ?>">
  <meta property="og:title" content="Top Up Premium - <?php echo $s0['instansi']; ?>"/>
       ...
       <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <div class="card shadow-sm d-none d-sm-block">
              <div class="card-header text-white" style="border-bottom: 1px solid rgb(255,255,255,0.5);">Produk Premium Lainnya</div>
                ...
                <ul class="list-group" style="border-radius: 0;">
                  ...
                  <li class="list-group-item" style="background: var(--primary-color); color: var(--font-color); border-radius: 0;">
                    <div class="media">
                      ...
                      <h5 class="mt-3" style="font-size: 14px; line-height: 12px; color: #fff;"><a href="<?php echo $urlweb; ?>/premium/<?php echo $gk['slug']; ?>/" style="color: #fff;"><?php echo $gk['kategori']; ?></a></h5>
                      </div>
                    </div>
                  </li>
                  <?php } ?>
            ...
            <div class="card shadow-sm mb-2" style="border-radius: 10px;">
              <div class="card-body mb-0" style="border-radius: 10px;">
                ...
                <div class="row pt-3 pl-2 pr-2 mb-2">
                  <?php
                    $kabupaten = mysqli_query($conn,"SELECT * FROM `tb_produk` WHERE kategori = '".$s6['kategori']."' AND status = 1 ORDER BY harga_jual ASC") or die(mysqli_error());
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#submitId").click(function () {
          uri = "<?php echo $urlweb; ?>/get_details.php?userID="+$("#userID").val()+"&zoneID="+$("#zoneID").val()+"&produkID="+$('input:radio[name=produkID]:checked').val()+"&metode="+$('input:radio[name=metode]:checked').val()+"&IDuser="+$("#IDuser").val()+"&noHp="+$("#noHp").val()+"&voucher="+$("#voucher").val()+"&ipaddress="+$("#ipaddress").val()+"&poin="+$("input:checkbox[name=point]:checked").val();
