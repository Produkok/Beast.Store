...
<head>
  ...
  <title>Testimonial - <?php echo $s0['instansi']; ?></title>
  <meta name="description" content="<?php echo $s0['deskripsi']; ?>">
  <meta name="keywords" content="<?php echo $s0['keyword']; ?>">
  <meta property="og:title" content="Testimonial - <?php echo $s0['instansi']; ?>"/>
       ...
       <div class="row">
          <div class="col-lg-12">
            <div class="pb-3">
              ...
              Terima kasih kepada semua pelanggan<br>yang memberikan ulasan dan penilaian<br>kepada kami.
              </h4>
              <div class="row">
                <?php
                  $getkategori = mysqli_query($conn,"SELECT a.*, b.* FROM tb_testi as a INNER JOIN tb_user as b ON a.userID = b.cuid WHERE a.status = 1 ORDER BY a.cuid DESC") or die(mysqli_error($conn));
                  $gkk = mysqli_num_rows($getkategori);
                  if($gkk == 0){
                    echo '
                      <div class="col-sm-12">
                    ...
                    while($gk = mysqli_fetch_array($getkategori)){
                      $noHp = 'xxxxx'.substr($gk['full_name'], 5);
                ?>
                <div class="col-sm-4">
                  <div class="card shadow-sm">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-12 pt-2 pb-2" style="font-size: 12px;">
                          "<?php echo $gk['content']; ?>"
                        </div>
                        <div class="col-6">
                          <span style="font-size: 14px;"><?php echo $noHp; ?></span><br>
                        </div>
