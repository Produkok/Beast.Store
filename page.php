...
$date = date('Y-m-d');
$slug = $_GET['p'];
$sql_page = mysqli_query($conn,"SELECT * FROM `tb_page` WHERE slug = '$slug'") or die(mysqli_error());
$sp = mysqli_fetch_array($sql_page);
$pageName = $sp['nama_page'];
$contentPage = $sp['content'];
...
<head>
  ...
  <title><?php echo $sp['nama_page']; ?> - <?php echo $s0['instansi']; ?></title>
  <meta name="description" content="<?php echo $s0['deskripsi']; ?>">
  <meta name="keywords" content="<?php echo $s0['keyword']; ?>">
  <meta property="og:title" content="<?php echo $sp['nama_page']; ?> - <?php echo $s0['instansi']; ?>"/>
