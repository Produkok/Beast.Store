...
$date = date('Y-m-d');
$stat = mysqli_query($conn,"INSERT INTO `tb_stat` (`ip`, `date`, `hits`, `page`, `user`) VALUES ('$ip', '$date', 1, 'Blog', '$pengguna')") or die (mysqli_error());
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Blog - <?php echo $s0['instansi']; ?></title>
  <meta name="description" content="<?php echo $s0['deskripsi']; ?>">
  <meta name="keywords" content="<?php echo $s0['keyword']; ?>">
  <meta property="og:title" content="Blog - <?php echo $s0['instansi']; ?>"/>
      ...
      <div class="container">
       <div class="row">
          <div class="col-lg-12">
            <div class="pb-3">
              <?php
                $sql_4 = mysqli_query($conn,"SELECT * FROM `tb_post` ORDER BY cuid DESC LIMIT 15") or die(mysqli_error());
