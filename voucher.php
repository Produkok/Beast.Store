...
<head>
  ...
  <title>Top Up Voucher - <?php echo $s0['instansi']; ?></title>
  <meta name="description" content="<?php echo $s0['deskripsi']; ?>">
  <meta name="keywords" content="<?php echo $s0['keyword']; ?>">
  <meta property="og:title" content="Top Up Voucher - <?php echo $s0['instansi']; ?>"/>
                ...
                <ul class="list-group" style="border-radius: 0;">
                  ...
                  <li class="list-group-item" style="background: var(--primary-color); color: var(--font-color); border-radius: 0;">
                    <div class="media">
                      ...
                      <h5 class="mt-3" style="font-size: 14px; line-height: 12px; color: #fff;"><a href="<?php echo $urlweb; ?>/voucher/<?php echo $gk['slug']; ?>/" style="color: #fff;"><?php echo $gk['kategori']; ?></a></h5>
                      </div>
                    </div>
                  </li>
                  <?php } ?>
